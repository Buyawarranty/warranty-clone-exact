    ...
    <div className="bg-[#e8f4fb] min-h-screen overflow-x-hidden">
      ...
      {currentStep === 1 && (
        <>
          ...
          {/* Warranty Information Content Section */}
          <section className="py-16 bg-gradient-to-b from-background to-muted/30">
            <div className="container mx-auto px-4 max-w-6xl">
                ...
                <div className="grid md:grid-cols-2 gap-8 items-start">
                  <div className="space-y-6">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">£5,000 or £5,000 per claim.</p>
                    </div>
                  </div>
              ...
              <div className="bg-card rounded-xl p-8 shadow-lg border">
                <h2 className="text-3xl font-bold text-center mb-8">Why Choose Buy-a-Warranty?</h2>
                
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                  <div className="flex items-start space-x-3">
                    <div className="w-2 h-2 bg-primary rounded-full mt-2 flex-shrink-0"></div>
                    <div>
                      <h4 className="font-semibold mb-1">No Excess:</h4>
                      <p className="text-sm text-muted-foreground">Never pay a penny towards repairs.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-3">
                    <div className="w-2 h-2 bg-primary rounded-full mt-2 flex-shrink-0"></div>
                    <div>
                      <h4 className="font-semibold mb-1">Unlimited Claims:</h4>
                      <p className="text-sm text-muted-foreground">Claim as many times as you need.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">From engine to electronics.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-3">
                    <div className="w-2 h-2 bg-primary rounded-full mt-2 flex-shrink-0"></div>
                    <div>
                      <h4 className="font-semibold mb-1">Free Collection:</h4>
                      <p className="text-sm text-muted-foreground">No collection & delivery fee.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">Claim-back recovery costs.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-3">
                    <div className="w-2 h-2 bg-primary rounded-full mt-2 flex-shrink-0"></div>
                    <div>
                      <h4 className="font-semibold mb-1">Nationwide Repairs:</h4>
                      <p className="text-sm text-muted-foreground">Repairs at trusted garages; Halfords, ATS, Kwik Fit.</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="mt-6 p-4 bg-primary/5 rounded-lg border border-primary/20">
                  <div className="flex items-start space-x-3">
                    <div className="w-2 h-2 bg-primary rounded-full mt-2 flex-shrink-0"></div>
                    <div>
                      <h4 className="font-semibold mb-1 text-primary">Flexible Plans:</h4>
                      <p className="text-sm text-muted-foreground">Available on 1, 2, or 3-year plans and monthly 0% APR options.</p>
                    </div>
                  </div>
                </div>
              </div>
